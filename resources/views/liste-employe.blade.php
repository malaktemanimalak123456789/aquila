            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Liste employe</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-end">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb justify-content-end">
                                ...
                                <li class="breadcrumb-item active">Liste employe</li>
                            </ol>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Liste employe : </h4>
                                    ...
                                    <table id="example23"
                                        ...
                                        @foreach($donnees as $donnee)
                                            <tr>
                                                ...
                                                <td>{{$donnee->ad}}</td>
                                                <td>
                                                <a href="modifier-employe/{{$donnee->id}}" class="btn btn-secondary">Modifier</a>

                                                    <a href="deleteEmploye/{{$donnee->id}}" class="btn btn-danger">Supprimer</a>
