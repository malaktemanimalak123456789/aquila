            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Devis </h4>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="form">
                                    <div class="form-group mt-5 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Devis : </label>
                                        <div class="col-10">
                                            <input class="form-control" type="number" value="3.12" id="example-text-input">
                                        </div>
                                    </div>
