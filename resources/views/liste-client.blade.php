            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Liste client</h4>
                    </div>
                                    ...
                                    <table id="example23"
                                        ...
                                        @foreach($donnees as $donnee)
                                            <tr>
                                                ...
                                                <td>{{$donnee->tel}}</td>
                                                <td>
                                                <a href="modifier-client/{{$donnee->id}}" class="btn btn-primary" >Modifier</a>

                                                    <a href="deleteClient/{{$donnee->id}}" class="btn btn-danger">Supprimer</a>
