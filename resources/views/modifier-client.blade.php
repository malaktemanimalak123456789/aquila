            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Modifier client </h4>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group mt-5 row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" value="{{$donnees->prenom}}" type="text" name="prenom"  id="example-text-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-5 row">
                                        ...
                                        <label for="example-text-input" class="col-2 col-form-label">activite</label>
                                        <div class="col-10">
                                            <input class="form-control" value="{{$donnees->activite}}" type="text" name="activite"  id="example-text-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-5 row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" value="{{$donnees->pays}}" type="text" name="pays"  id="example-text-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-5 row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" value="{{$donnees->tel}}" type="text" name="tel"  id="example-text-input">
                                        </div>
                                    </div>
