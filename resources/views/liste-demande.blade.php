            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Liste demande rendez vous</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-end">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb justify-content-end">
                                ...
                                <li class="breadcrumb-item active">Liste demande rendez vous</li>
                            </ol>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Liste demande rendez vous : </h4>
                                ...
                                @endif
                                    <table id="example23"
                                        ...
                                        @foreach($donnees as $donnee)
                                            <tr>
                                                <td>{{$donnee->title}}</td>
                                                <td>{{$donnee->employe}}</td>
                                                <td>{{$donnee->prix}}</td>
                                                <td>{{$donnee->created_at}}</td>
                                                <td>
                                                <a href="modifier-rendezvous/{{$donnee->id}}" class="btn btn-primary">Modifier</a>
                                                    <a href="deleterendezvous/{{$donnee->id}}" class="btn btn-danger">Supprimer</a>
