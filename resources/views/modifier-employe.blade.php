            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Modifier employe </h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Modifier employe :</h4>
                                ...
                                @csrf
                                    ...
                                    <div class="form-group mt-5 row">
                                        ...
                                        <label for="example-text-input" class="col-2 col-form-label">Ad</label>
                                        <div class="col-10">
                                            <input class="form-control" value="{{$donnees->ad}}" type="text" name="ad" id="example-text-input">
                                        </div>
                                    </div>
