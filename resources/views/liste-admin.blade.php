            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Liste admin</h4>
                    </div>
                                    ...
                                    <table id="example23"
                                        ...
                                        @foreach($donnees as $donnee)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="modifier-admin/{{$donnee->id}}" class="btn btn-primary">Modifier</a>
                                                    <a href="deleteAdmin/{{$donnee->id}}" class="btn btn-danger">Supprimer</a>
                                                </td>
                                            </tr>
                                            @endforeach 
                                        </tbody>
