            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Modifier Rendez-vous </h4>
                    </div>
                    <div class="col-md-7 align-self-center text-end">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb justify-content-end">
                                ...
                                <li class="breadcrumb-item active">Modifier  Rendez-vous</li>
                            </ol>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Modifier Rendez-vous :</h4>
                                <form action="/editRendezvous" method="post"   >
                                @csrf
                                    ...
                                    <input type="hidden" name="id" value="{{$donnees->id}}">
                                        ...
                                        <label for="example-text-input" class="col-2 col-form-label">Titre de RDV	 </label>
                                        <div class="col-10">
                                            <input class="form-control" value="{{$donnees->title}}" type="text" name="title" id="example-text-input">
                                        </div>
                                    </div> 
                                    ...
                                    <div class="form-group mt-5 row">
                                        ...
                                        <label for="example-text-input" class="col-2 col-form-label">Employe</label>
                                        <div class="col-10">
                                            <input class="form-control" value="{{$donnees->employe}}" type="text" name="employe"  id="example-text-input">
                                        </div>
                                    </div>
                                   
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-2 col-form-label">Prix</label>
                                        <div class="col-10">
                                            <input class="form-control" value="{{$donnees->prix}}" type="text" name="prix"   id="example-email-input">
                                        </div>
                                    </div>
